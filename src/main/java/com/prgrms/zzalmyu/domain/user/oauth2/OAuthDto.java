...
import com.prgrms.zzalmyu.domain.user.oauth2.userinfo.GoogleOAuth2UserInfo;
import com.prgrms.zzalmyu.domain.user.oauth2.userinfo.KakaoOAuth2UserInfo;
import com.prgrms.zzalmyu.domain.user.oauth2.userinfo.NaverOAuth2UserInfo;
